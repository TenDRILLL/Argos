...
export function getPreload(url){
    ...
    <body>
      ...
      * {box-sizing: border-box;}
      ...
      .circle {position: absolute;border-radius: 50%;border: 1px solid #7d7d7d; z-index: 1; background-color: transparent;}
      .shape_group {position: absolute;display: grid;place-items: center;height: 8rem;width: 8rem;overflow: hidden;}
      .shape_group .shape {position: absolute;border-left: 2.85rem solid transparent;border-right: 2.85rem solid transparent; border-bottom: 4.9rem solid #7d7d7d;}
      .line_group {position: absolute; }
      .line_group .line {position: absolute;height: 100%;width: 1px; background: linear-gradient(to bottom, transparent 0%, #7d7d7d 20%, #7d7d7d 70%, transparent 100%);}
      .line_group .line.l1 {left: 0;}
      .line_group .line.l2 {left: 33%;}
      .line_group .line.l3 {left: 67%;}
      .line_group .line.l4 {left: 100%;}
    
      .default .c1 {height: 10rem;width: 10rem;transition: all 2s ease-in-out;}
      .default .c2 {height: 9rem;width: 9rem;transition: all 2s ease-in-out;}
      .default .c3 {height: 9rem;width: 9rem;transition: all 2s ease-in-out;}
      .default .c4 {height: 8rem;width: 8rem;transition: all 2s ease-in-out;}
      .default .shape_group {transition: height 2s ease-in-out;}
      .default .shape_group .shape {transition: transform 2s ease-in-out, border-bottom-color 0.75s ease-in 1.25s; border-bottom-color: #030303;transform: rotate(180deg);}
      .default .line_group {transition: all 2s ease-in-out;}
      .default .line_group .line {transition: all 2s ease-in-out;}
      .default .line_group.g1 {height: 15rem;width: 6rem;}
      .default .line_group.g2 {height: 15rem;width: 7.75rem;transform: rotate(-60deg);}
      .default .line_group.g3 {height: 15rem;width: 7.75rem;transform: rotate(60deg);}
    
      .warlock .c1 {height: 6.25rem;width: 6.25rem; transition: all 2s ease-in-out;}
      .warlock .c2 {height: 4rem;width: 4rem; transition: all 2s ease-in-out;}
      .warlock .c3 {height: 12.5rem;width: 12.5rem; transition: all 1s ease-in-out 1s;}
      .warlock .c4 {height: 11.5rem;width: 11.5rem; transition: all 1s ease-in-out 1s;}
      .warlock .shape_group .shape {transition: transform 2s ease-in-out, border-bottom-color 0.75s ease-in 1.25s;}
      .warlock .shape_group .shape.s1, .warlock .shape_group .shape.s4 {transform: rotate(0) translate(-1.15rem, 0.5rem);}
      .warlock .shape_group .shape.s2, .warlock .shape_group .shape.s5 {transform: rotate(360deg) translate(0, 0.5rem);}
      .warlock .shape_group .shape.s3, .warlock .shape_group .shape.s6 {transform: rotate(360deg) translate(1.15rem, 0.5rem);}
      .warlock .line_group {transition: all 2s ease-in-out; }
      .warlock .line_group .line {transition: all 2s ease-in-out; box-shadow: 0 0 0 2px #030303;}
      .warlock .line_group.g1 {height: 15rem;width: 6rem;transform: rotate(-90deg);}
      .warlock .line_group.g1 .l2,
      .warlock .line_group.g1 .l3 {opacity: 0;}
      .warlock .line_group.g2 {height: 15rem;width: 4rem;transform: rotate(-150deg);}
      .warlock .line_group.g2 .l1 {left: 50%;}
      .warlock .line_group.g2 .l2 {left: 74%;}
      .warlock .line_group.g2 .l3 {left: 77%;}
      .warlock .line_group.g2 .l4 {left: 100%;}
      .warlock .line_group.g3 {height: 15rem;width: 4rem;transform: rotate(150deg);}
      .warlock .line_group.g3 .l1 {left: 0%;}
      .warlock .line_group.g3 .l2 {left: 24%;}
      .warlock .line_group.g3 .l3 {left: 27%;}
      .warlock .line_group.g3 .l4 {left: 50%;}
    
      .titan .c1 {height: 10.5rem;width: 10.5rem;transition: all 2s ease-in-out;}
      .titan .c2 {height: 10rem;width: 10rem;transition: all 2s ease-in-out;}
      .titan .c3 {height: 12rem;width: 12rem;transition: all 1s ease-in-out 1s;}
      .titan .c4 {height: 11rem;width: 11rem;transition: all 1s ease-in-out 1s;}
      .titan .shape_group .shape {transition: transform 2s ease-in-out;}
      .titan .shape_group .shape.s1 {transform: rotate(-90deg) scale(0.535) translate(-3.1rem, -2.5rem);}
      .titan .shape_group .shape.s2 {transform: rotate(270deg) scale(0.535) translate(3.1rem, -2.5rem);}
      .titan .shape_group .shape.s3 {transform: rotate(270deg) scale(0.485) translate(0, 3rem);}
      .titan .shape_group .shape.s4 {transform: rotate(90deg) scale(0.485) translate(0, 3rem);}
      .titan .shape_group .shape.s5 {transform: rotate(450deg) scale(0.535) translate(-3.1rem, -2.4rem);}
      .titan .shape_group .shape.s6 {transform: rotate(450deg) scale(0.535) translate(3.1rem, -2.4rem);}
      .titan .line_group {transition: all 2s ease-in-out;}
      .titan .line_group .line {transition: all 2s ease-in-out;}
      .titan .line_group.g1 {height: 15rem;width: 5.25rem;transform: rotate(-180deg);}
      .titan .line_group.g1 .l2,
      .titan .line_group.g1 .l3 {opacity: 0;}
      .titan .line_group.g2 {height: 15rem; width: 5.5rem;transform: rotate(-240deg);}
      .titan .line_group.g2 .l1 {left: 0%;}
      .titan .line_group.g2 .l2 {left: 48%;}
      .titan .line_group.g2 .l3 {left: 52%;}
      .titan .line_group.g2 .l4 {left: 100%;}
      .titan .line_group.g3 {height: 15rem;width: 5.5rem;transform: rotate(240deg);}
      .titan .line_group.g3 .l1 {left: 0%;}
      .titan .line_group.g3 .l2 {left: 48%;}
      .titan .line_group.g3 .l3 {left: 52%;}
      .titan .line_group.g3 .l4 {left: 100%;}
    
      .hunter .c1 {height: 5.5rem;width: 5.5rem;transition: all 2s ease-in-out; }
      .hunter .c2 {height: 4rem;width: 4rem;transition: all 2s ease-in-out;}
      .hunter .c3 {height: 9rem;width: 9rem;transition: all 2s ease-in-out;}
      .hunter .c4 {height: 8rem;width: 8rem;transition: all 2s ease-in-out;}
      .hunter .shape_group {transition: height 2s ease-in-out;height: 6rem;}
      .hunter .shape_group .shape {transition: all 2s ease-in-out, border-bottom-color 0.75s ease-in 1.25s;}
      .hunter .shape_group .shape.s1 {transform: rotate(0deg) scale(0.83) translate(0, 1.2rem);}
      .hunter .shape_group .shape.s2 {transform: rotate(360deg) scale(0.83) translate(0, -3.6rem);}
      .hunter .shape_group .shape.s3 {transform: rotate(360deg) scale(0.83) translate(0, -1.2rem);}
      .hunter .shape_group .shape.s4 {border-bottom-color: #030303;transform: rotate(0deg) scale(0.4) translate(0, 0);}
      .hunter .shape_group .shape.s5 {border-bottom-color: #030303;transform: rotate(360deg) scale(0.4) translate(0, -5rem);}
      .hunter .shape_group .shape.s6 {border-bottom-color: #030303;transform: rotate(360deg) scale(0.4) translate(0, 5rem);}
      .hunter .line_group {transition: all 2s ease-in-out;}
      .hunter .line_group .line {transition: all 2s ease-in-out;}
      .hunter .line_group.g1 {height: 15rem;width: 6rem;transform: rotate(-270deg);}
      .hunter .line_group.g2 {height: 15rem;width: 5rem;transform: rotate(-330deg);}
      .hunter .line_group.g2 .l1 {left: 0%;}
      .hunter .line_group.g2 .l2 {left: 20%;}
      .hunter .line_group.g2 .l3 {left: 40%;z-index: -1;}
      .hunter .line_group.g2 .l4 {left: 60%;z-index: -1;}
      .hunter .line_group.g3 {height: 15rem;width: 5rem;transform: rotate(330deg);}
      .hunter .line_group.g3 .l1 {left: 40%;}
      .hunter .line_group.g3 .l2 {left: 60%;}
      .hunter .line_group.g3 .l3 {left: 80%;}
      .hunter .line_group.g3 .l4 {left: 100%;}
